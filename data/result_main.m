...
for k = 1 : length(setup) % loop through different simulation set ups
    ...
    %    exact_iterTime_mean(k, n) = runs_elapsed_time_effiMulti(n)/rep;
    %    approx_iterTime_mean(k, n) = runs_elapsed_time_approx(n)/rep;
    %end
end

info_filename = 'exact_timedriven_summarystats.mat';
